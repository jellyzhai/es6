...
var _lazyInitialize = __webpack_require__(127);
...
var _lottery = __webpack_require__(369);
...

{
  ...
  var _o$p = _o.p,
      _p = _o$p === undefined ? 1 : _o$p,
      _o$q = _o.q,
      _q = _o$q === undefined ? false : _o$q;
  //console.log(p,q)
...
//json对象解构赋值
{
  ...
  var eTitle = data.title,
      _data$dec = _slicedToArray(data.dec, 1),
      iTitle = _data$dec[0].title;
...
{
  var reg = new RegExp('xy', 'i');
  var reg2 = new RegExp(/xy/i);

  //console.log(reg.test('Xyq'),reg2.test('Xq'));

  //'i'覆盖g规则
  var reg3 = new RegExp(/xy/g, 'i');
...
{
  var s = 'bbb-bb-b';
  var r = /b+/g; //全局匹配，第二次会从第二个符合条件的地方继续匹配
  var r2 = new RegExp('b+', 'y'); //yard逐个局部匹配，只匹配一次
...
//数组的keys(),values(),entries()方法
{
  ...
  try {
    for (var _iterator = [1, 'ok', 2].keys()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      // console.log(i)
  ...
  try {
    for (var _iterator2 = [1, 'ok', 2].values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      // console.log(i)
  ...
  try {
    for (var _iterator3 = [1, 'ok', 2].entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      // console.log(i,v)
...
//使用
{
  ...
  var _a = Symbol.for('a');
  var o = (_o = {}, _defineProperty(_o, _a, 123), _defineProperty(_o, 'a', 234), _defineProperty(_o, 'b', 345), _o);
...
//map set array object的增删改查对比
{
  ...
  //查
  var mExist = _m2.has('q');
  var sExist = s.has(ot);
  var oExist = 'q' in _o2; //原来的命令式查询方法
  var oExistNew = Reflect.has(_o2, 'q'); //未来建议使用的查询属性方法
  var arrExist = _arr4.includes(ot); //find返回符合条件的元素
  ...
  _m2.delete('q');
  s.forEach(function (i) {
    return i.q ? s.delete(i) : '';
  });
  delete _o2.q; //原来命令式的删除对象属性的操作
  Reflect.deleteProperty(_o2, 'q'); //未来建议使用的对象删除属性方法
  var arrIndex = _arr4.findIndex(function (i) {
    i.q;
  });
  _arr4.splice(arrIndex, 1);
    ...
    return new Proxy(target, { //对象参数
      ...
      set: function set(target, key, value, proxy) {
        ...
        if (target.hasOwnProperty(key)) {
          var valRule = this._validator[key];
          if (!!valRule(value)) {
...
var _coreDecorators = __webpack_require__(345);
...
//使用 core-decorators 库的 autobind 方法绑定class原型上的 方法中的this 指向当前类的实例
{
  ...
  var Person = (_class = function () {
    ...
    return Person;
  }(), (_applyDecoratedDescriptor(_class.prototype, 'go', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'go'), _class.prototype)), _class);
...
//@autobind 整个类中的普通方法 都绑定this
{
  ...
  var _Person = (0, _coreDecorators.autobind)(_class2 = function () {
    function _Person() {
...
{
  var _desc2, _value2, _class3, _descriptor;

  // 只能用于直接在类中写name='jelly';属性
  var _Person2 = (_class3 = function _Person2() {
    _classCallCheck(this, _Person2);

    _initDefineProp(this, 'name', _descriptor, this);
  }, (_descriptor = _applyDecoratedDescriptor(_class3.prototype, 'name', [_coreDecorators.readonly], {
    enumerable: true,
    initializer: function initializer() {
      return 'jelly';
    }
...
//@override 用于子类函数 是否正确覆盖了 父类的函数
{
  ...
  var Child = function (_Person4) {
    _inherits(Child, _Person4);
...
//@deprecate 用于 调用方法时 在控制台警告提示方法将会被弃用
{
  ...
  var Parent = (_class5 = function () {
    ...
    return Parent;
  }(), (_applyDecoratedDescriptor(_class5.prototype, 'say', [_coreDecorators.deprecate], Object.getOwnPropertyDescriptor(_class5.prototype, 'say'), _class5.prototype)), _class5);

  var _Child = function (_Parent) {
    _inherits(_Child, _Parent);
...
{
  var _desc4, _value4, _class6;

  var _Parent2 = (_class6 = function () {
    function _Parent2() {
      _classCallCheck(this, _Parent2);
    }

    _createClass(_Parent2, [{
      key: 'say',
      value: function say() {
        return 'say2';
      }
      ...
      key: 'goSay',
      value: function goSay() {
        return this.say();
      }
    }]);

    return _Parent2;
  }(), (_applyDecoratedDescriptor(_class6.prototype, 'say', [_coreDecorators.deprecate], Object.getOwnPropertyDescriptor(_class6.prototype, 'say'), _class6.prototype), _applyDecoratedDescriptor(_class6.prototype, 'goSay', [_coreDecorators.suppressWarnings], Object.getOwnPropertyDescriptor(_class6.prototype, 'goSay'), _class6.prototype)), _class6);

  var parent = new _Parent2();
  //调用方法时依然还会有警告提示
...
{
  var _desc5, _value5, _class7, _descriptor2;

  var _say2 = function _say2() {
    console.log('被调用了');
    return 111 + 999;
  };

  var _Person5 = (_class7 = function _Person5() {
    _classCallCheck(this, _Person5);

    _initDefineProp(this, 'age', _descriptor2, this);
  }, (_descriptor2 = _applyDecoratedDescriptor(_class7.prototype, 'age', [_coreDecorators.lazyInitialize], {
    enumerable: true,
    initializer: function initializer() {
      return _say2();
    }
...
{
  var _desc6, _value6, _class9, _descriptor3;

  var _Person6 = (_class9 = function _Person6() {
    var _this3 = this;
  ...
  }, (_descriptor3 = _applyDecoratedDescriptor(_class9.prototype, 'name', [_coreDecorators.nonenumerable], {
    enumerable: true,
    initializer: function initializer() {
      return 'jelly';
    }
...
//@readonly 让类的实例属性 只读，不可修改属性值
{
  var _desc7, _value7, _class11, _descriptor4;

  // 只能用于直接在类中写name='jelly';属性
  var _Person7 = (_class11 = function _Person7() {
    _classCallCheck(this, _Person7);

    _initDefineProp(this, 'name', _descriptor4, this);
  }, (_descriptor4 = _applyDecoratedDescriptor(_class11.prototype, 'name', [_coreDecorators.readonly], {
    enumerable: true,
    initializer: function initializer() {
      return 'jelly';
    }
...
//类的继承
{
  var _Parent4 = function _Parent4() {
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'mukewang';
  ...
  var _Child2 = function (_Parent5) {
    _inherits(_Child2, _Parent5);

    function _Child2() {
      var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'child';

      _classCallCheck(this, _Child2);

      //一定要在子构造函数的顶部，否则会报错，相当于调用父类的构造函数
      var _this4 = _possibleConstructorReturn(this, (_Child2.__proto__ || Object.getPrototypeOf(_Child2)).call(this, name));
...
var _override = __webpack_require__(346);
...
var _deprecate = __webpack_require__(347);
...
var _suppressWarnings = __webpack_require__(348);
...
var _memoize = __webpack_require__(349);
...
var _autobind = __webpack_require__(350);
...
var _readonly = __webpack_require__(351);
...
var _enumerable = __webpack_require__(352);
...
var _nonenumerable = __webpack_require__(353);
...
var _nonconfigurable = __webpack_require__(354);
...
var _debounce = __webpack_require__(355);
...
var _decorate = __webpack_require__(357);
...
var _mixin = __webpack_require__(358);
...
var _extendDescriptor = __webpack_require__(360);
...
var _applyDecorators = __webpack_require__(362);
...
{
  var loadImg = function loadImg(imgAddr) {
    return new Promise(function (resolve, reject) {
...
{
  var _loadImg = function _loadImg(imgAddr) {
    return new Promise(function (resolve, reject) {
      var img = document.createElement('img');
      img.src = imgAddr;
...

{
  ...
  /*---------------让对象可以使用for of 方法---------------*/
  var iretable = function iretable(obj) {
    var _airObj;

    var airObj = (_airObj = {}, _defineProperty(_airObj, Symbol.for('index'), 0), _defineProperty(_airObj, Symbol.iterator, function () {
      return this;
    }), _defineProperty(_airObj, 'next', function next() {
      var keysArr = Reflect.ownKeys(this);
      var len = keysArr.length;
      var thisProto = Reflect.getPrototypeOf(this);
      var i = thisProto[Symbol.for('index')];
  ...
  var _obj = _defineProperty({
    ...
    //将obj对象的值转成数组 就可以直接使用let of for方法
    var self = this;
    var arr = [].concat(_toConsumableArray(self.a), _toConsumableArray(self.b));
    var index = 0;
    var len = arr.length;
  ...
  var o = _defineProperty({ 'a': 1, 'b': 2, 'c': { 'd': 4, 'e': 5 } }, Symbol('age'), 26);
  o = iretable(o);
...
var _co = __webpack_require__(366);
...
//定义
{
  ...
  var _g = /*#__PURE__*/regeneratorRuntime.mark(function _g() {
    return regeneratorRuntime.wrap(function _g$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            return _context3.abrupt('return', 'ending');
...
* */
{
  var f = /*#__PURE__*/regeneratorRuntime.mark(function f() {
    return regeneratorRuntime.wrap(function f$(_context5) {
      while (1) {
...
* */
{
  var _gen3 = /*#__PURE__*/regeneratorRuntime.mark(function _gen3() {
    var i, a, b;
    return regeneratorRuntime.wrap(function _gen3$(_context6) {
      while (1) {
...

{
  var _gen4 = /*#__PURE__*/regeneratorRuntime.mark(function _gen4() {
    return regeneratorRuntime.wrap(function _gen4$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 10:
            return _context7.abrupt('return', 6);
...
* */
{
  var _gen5 = /*#__PURE__*/regeneratorRuntime.mark(function _gen5() {
    var a;
    return regeneratorRuntime.wrap(function _gen5$(_context8) {
      while (1) {
...
* */
{
  var foo = /*#__PURE__*/regeneratorRuntime.mark(function foo() {
    return regeneratorRuntime.wrap(function foo$(_context9) {
      while (1) {
  ...
  var bar = /*#__PURE__*/regeneratorRuntime.mark(function bar() {
    var f;
    return regeneratorRuntime.wrap(function bar$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            return _context10.delegateYield(foo(), 't0', 1);
...
{
  var _gen6 = /*#__PURE__*/regeneratorRuntime.mark(function _gen6() {
    return regeneratorRuntime.wrap(function _gen6$(_context11) {
      while (1) {
...
//异步操作的同步化写法
{
  var _gen7 = /*#__PURE__*/regeneratorRuntime.mark(function _gen7() {
    return regeneratorRuntime.wrap(function _gen7$(_context12) {
      while (1) {
        switch (_context12.prev = _context12.next) {
          ...
          case 8:
            ...
            _context12.t2.log.call(_context12.t2, _context12.t3);

            _context12.t4 = console;
            _context12.next = 13;
            return request('http://localhost:8080/');
          ...
          case 13:
            ...
            _context12.t4.log.call(_context12.t4, _context12.t5);
...
{
  var o = { a: 0 };
  o[Symbol.iterator] = /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
...
//抽奖
{
  ...
  var reduce = /*#__PURE__*/regeneratorRuntime.mark(function reduce(count) {
    return regeneratorRuntime.wrap(function reduce$(_context14) {
      while (1) {
...
//generator函数 和 promise对象结合使用，进行长轮询
{
  var pull = function pull() {
    var g = ajax();
    var p = g.next().value; //g.next()返回的是{value:Promise对象,done:boolean}
  ...
  var ajax = /*#__PURE__*/regeneratorRuntime.mark(function ajax() {
    return regeneratorRuntime.wrap(function ajax$(_context15) {
      while (1) {
...
//decorators 修饰器是一个函数，用于修饰类的属性的行为状态
{
  ...
  var Test = (_class = function () {
    ...
    return Test;
  }(), (_applyDecoratedDescriptor(_class.prototype, 'time', [decorator], Object.getOwnPropertyDescriptor(_class.prototype, 'time'), _class.prototype)), _class);
...
//修饰符在类外部
{
  ...
  var type = function type(target, name, desc) {
    target.type = 'hi'; //给类添加静态属性
  };

  //修饰器后面不能加标点符号
  var _Test = type(_class2 = function _Test() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              v1 = void 0, v2 = void 0, v3 = void 0, v4 = void 0;
              _context.prev = 1;
              _context.next = 4;
              return p(1);
            ...
            case 19:
              return _context.abrupt("return", { v1: v1, v2: v2, v3: v3, v4: v4 });
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 4;
              return Promise.all([_p(1), _p(2), _p(3)]);
            ...
            case 15:
              return _context2.abrupt("return", { v1: v1, v2: v2, v3: v3, v4: v4 });
  ...
  _createClass(Timer, [{
    ...
    value: function countdown(end, update, handle) {
      ...
      if (now - end > 0) {
        ...
        var d_ms = 24 * 60 * 60 * 1000;
        var h_ms = 60 * 60 * 1000;
        var m_ms = 60 * 1000;
        var ms = 1000;

        var d = Math.floor(lastTime / d_ms);
        var h = Math.floor((lastTime - d * d_ms) / h_ms);
        var m = Math.floor((lastTime - d * d_ms - h * h_ms) / m_ms);
        var s = Math.floor((lastTime - d * d_ms - h * h_ms - m * m_ms) / ms);
